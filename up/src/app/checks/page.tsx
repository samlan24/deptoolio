      ...
      <main className="min-h-screen pt-20 max-w-4xl mx-auto pb-6">
        ...
        <section className="mt-12">
          ...
          <p className="text-gray-200 mb-4">
            ...
            <strong>compatible</strong>, and <strong>performant</strong>.
            Outdated dependencies often introduce risks such as security
            vulnerabilities, deprecated APIs, or performance bottlenecks.
          </p>
          <ul className="list-disc list-inside text-gray-200 space-y-2">
            <li>
              <strong>Security:</strong> Patching vulnerabilities quickly
              reduces your project’s attack surface.
            </li>
            <li>
        ...
        <section className="mt-12">
          ...
          <p className="text-gray-200 mt-4">
            Once uploaded, the app will scan your dependencies and highlight
            which ones are outdated. Take note of the following best practices:
          </p>
          <ol className="list-decimal list-inside text-gray-200 space-y-2 mt-2">
            ...
            <li>
              <strong>Rescan anytime:</strong> You can always re-upload your
              files to this app to check for new outdated dependencies as your
              project evolves.
            </li>
          </ol>
        </section>
