...
import { CheckCircle, AlertCircle, XCircle, FileText, Package, Code } from 'lucide-react';
...
export default function Home() {
  ...
  const detectFileType = (filename: string): FileType => {
    ...
    if (lowercaseName.includes('requirements') ||
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (fileType === 'unknown') {
      alert('Unsupported file type. Please upload package.json, requirements.txt, Pipfile, or pyproject.toml');
      return;
    }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center">
          ...
          <div className="mb-6">
            ...
            >
              <div className="text-center">
                ...
                <span className="text-lg text-gray-700 font-medium">Upload dependency file</span>
          ...
          {fileName && detectedFileType !== 'unknown' && (
            <div className={`inline-flex items-center space-x-2 px-4 py-2 rounded-full ${fileTypeInfo.bgColor} mb-6`}>
              {fileTypeInfo.icon}
